...
const HomeDashboard = () => {
  ...
  const electronicsCategories = categories.filter(cat => cat.group === "Electronics");
  const homeAppliancesCategories = categories.filter(cat => cat.group === "Home Appliances");
  ...
  return (
    <div className="container mx-auto px-4 py-12 bg-gray-50 min-h-screen mt-10">
      ...
      {renderCategorySection("Best Deals on Home Appliances", homeAppliancesCategories)}
    </div>
  );
};
