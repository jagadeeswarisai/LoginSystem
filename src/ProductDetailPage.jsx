...
const ProductDetailPage = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-4xl mx-auto bg-gray-50 shadow-md rounded-2xl p-6 sm:p-8 md:p-10 hover:scale-105 transition-transform duration-300">
        <div className="flex flex-col md:flex-row gap-6">
          {/* Image Section */}
          <div className="md:w-1/2 flex justify-center items-center">
            <img
              src={product.image} // ✅ Use Cloudinary image URL directly
              alt={product.name}
          ...
          <div className="md:w-1/2">
            ...
            <p className="text-gray-700 mb-2">
              <span className="font-bold">Height:</span> {product.height} mm
            </p>
            <p className="text-gray-700 mb-2">
              <span className="font-bold">Width:</span> {product.width} mm
            </p>
            <p className="text-gray-700 mb-2">
